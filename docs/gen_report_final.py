...
h2("6.2 时空规律")
body("时段分布如图2，呈明显“早晚双峰”：早高峰 8 时、晚高峰 17-19 时（峰值出现在 18 时），"
     "符合通勤出行特征；工作日骑行总量约为周末的 3.1 倍（151,482 vs 48,518 次，图3）。")
...
body("人工修改与优化说明：架构与分工设计、清洗阈值确认（60s/24h 与官方口径一致）、结果合理性"
     ...
     "均为人工完成。")
body("最终成果与 AI 生成内容的差异：AI 生成了模块初始代码的主要框架，但全部经过人工运行验证"
     "与修改；接口契约、路径规范、异常兜底与结果核验等关键环节均由人工主导，体现“AI 初稿+"
     "人工优化”的完整过程。")
